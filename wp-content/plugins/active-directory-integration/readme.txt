...
Good news, everyone! We rewrote this plugin from scratch and added new features and a smoother user interface. Please welcome [Next ADI](https://wordpress.org/plugins/next-active-directory-integration)!
The new *Next ADI* plugin will always stay free and open source. The development can be tracked on [GitHub](https://github.com/NeosIT/active-directory-integration2). Along with *Next ADI* we also intruduce our [professional support](https://www.active-directory-wp.com) for agencys, developers and site owners. Please note that the ADI v1 plugin is now deprecated and will not longer be supported.
