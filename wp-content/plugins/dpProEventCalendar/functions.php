...
function dpProEventCalendar_pro_event_calendar_init() {
  ...
  $events_slug = ( $dpProEventCalendar['events_slug'] != "" ? $dpProEventCalendar['events_slug'] : 'pec-events');
  ...
  $args = array(
    ...
    'show_in_menu' => true, 
    'query_var' => true,
    'rewrite' => array( 'slug' => 'pec-venues', 'with_front' => false ),
    'capability_type' => 'post',
    'has_archive' => false, 
    'hierarchical' => false,
	'show_in_menu' => 'dpProEventCalendar-admin',
  ...
  $args = array(
    ...
    'show_in_menu' => true, 
    'query_var' => true,
    'rewrite' => array( 'slug' => 'pec-organizers', 'with_front' => false ),
    'capability_type' => 'post',
    'has_archive' => false, 
    'hierarchical' => false,
	'show_in_menu' => 'dpProEventCalendar-admin',
...
function dpProEventCalendar_pro_event_calendar_taxonomies() 
{
  ...
  $args = array(
    ...
    'query_var'           => true,
    'show_in_rest'       => true,
    'rewrite'             => array( 'with_front' => false, 'slug' => ( $dpProEventCalendar['categories_slug'] != "" ? $dpProEventCalendar['categories_slug'] : 'pec_events_category') )
  );
...
function dpProEventCalendar_booking_reminder() {
	...
	$booking_search_date = date('Y-m-d', strtotime('+3 days'));
...
function dpProEventCalendar_importICS($calendar_id, $filename, $tmp_filename = '', $category_ics = '', $offset = '') {
	global $dpProEventCalendar_cache, $dpProEventCalendar;
			...
			if(is_array($feed['VEVENT'])) {
				foreach($feed['VEVENT'] as $key) {
					...
					if(isset($feed['STANDARD'][0]['TZOFFSETTO'])) {
						...
						$tzid = timezone_name_from_abbr('', $seconds, false);
					}
