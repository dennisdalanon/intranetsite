...
function dpProEventCalendar_events_side_display( $post ) {
	...
	$dpProEventCalendar_class->switchCalendarTo('compact');
    ...
    <div id="misc-publishing-actions">
        ...
        <div class="misc-pub-section">
            ...
            <input type="text" readonly="readonly" name="pec_date" maxlength="10" onfocus="jQuery('.dpProEventCalendar_btn_getEventDate').trigger('click');" id="pec_date" class="large-text" value="<?php echo $pec_date != '' ? date("Y-m-d", strtotime($pec_date)) : ''?>" style="width:100px;" />
            <button type="button" class="dpProEventCalendar_btn_getEventDate button">
                <img src="<?php echo dpProEventCalendar_plugin_url( 'images/admin/calendar.png' ); ?>" alt="Calendar" title="Calendar">
            </button>
        </div>
        ...
        <div class="misc-pub-section misc-pub-timezone">
        	<label for="pec_timezone"><?php _e('Select a Timezone', 'dpProEventCalendar'); ?></label>
        ...
        <div class="misc-pub-section">
            ...
            <input type="text" readonly="readonly" onfocus="jQuery('.dpProEventCalendar_btn_getEventEndDate').trigger('click');" name="pec_end_date" maxlength="10" id="pec_end_date" class="large-text" value="<?php echo $pec_end_date != '0000-00-00' ? $pec_end_date : ''?>" style="width:100px;" />
            <button type="button" class="dpProEventCalendar_btn_getEventEndDate button">
                <img src="<?php echo dpProEventCalendar_plugin_url( 'images/admin/calendar.png' ); ?>" alt="Calendar" title="Calendar">
            </button>
            <button type="button" class="button" onclick="jQuery('#pec_end_date').val('');">
        ...
        <div class="misc-pub-section">
			<label for="pec_extra_dates"><?php _e('Extra Dates','dpProEventCalendar'); ?></label> <input type="text" name="pec_extra_dates" id="pec_extra_dates" value="<?php echo $pec_extra_dates?>" />
