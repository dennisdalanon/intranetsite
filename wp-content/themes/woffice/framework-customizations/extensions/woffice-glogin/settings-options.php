...
$options = array(
	'google-login' => array(
		'type'    => 'tab',
		'title'   => __( 'Google Login (Depreciated)', 'woffice' ),
		'options' => array(
            'important' => array(
                'label' => __( 'Important :', 'woffice' ),
                'type'  => 'html',
                'html'  => '<b class="highlight">This extension will be removed by Woffice 2.6.0 and is depreciated, those settings will not work, it has been moved to <u>Theme Settings > Login / Register</u>. Feel free to just copy/past these fields and you are ready to go.</b>',
            ),
			'google_info' => array(
				'label' => __( 'Old extension :', 'woffice' ),
				'type'  => 'html',
				'html'  => '<strike>Please make sure you have read the <a href="https://2f.ticksy.com/article/4261" target="_blank">tutorial about Google Login</a>. Because there is some steps in Google Console API to do in order to make it working. Don\t forget the product name in the "Consent Screen" page, it is important so you will be able to generate  a redirect URI.</strike>',
			),
			'callbackurl' => array(
