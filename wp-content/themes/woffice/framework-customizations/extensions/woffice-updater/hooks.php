...
function woffice_pre_set_transient_update_theme ( $transient )
{
    ...
    if ($status == "checked") {
        ...
        if ($enable_hub) {
             ...
             * We call our API
             */
            $raw_response = wp_remote_get('https://hub.alka-web.com/api/woffice/version/', $request_string);
            ...
            wp_remote_post('https://hub.alka-web.com/api/license/key/', $request_string_product);
