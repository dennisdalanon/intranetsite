		...
		'options' => array(
			...
			'projects-box' => array(
				...
				'options' => array(
					...
					'projects_archived_filter'    => array(
						'label' => __( 'Enable archive filter', 'woffice' ),
						'desc'  => __( 'This is a toggle button to show/hide the archived projects', 'woffice' ),
						'type'         => 'switch',
						'right-choice' => array(
                            'value' => 'yep',
							'label' => __( 'Yep', 'woffice' )
					...
					'hide_projects_completed'    => array(
						...
						'desc'  => __( 'If the archived projects have to be displayed in the listing or not by default (They can be displayed using the toggle, if it is enabled above).', 'woffice' ),
						'type'         => 'switch',
						'right-choice' => array(
							'value' => true,
							'label' => __( 'Yep', 'woffice' )
