...
function woffice_get_custom_css()
{
	...
	**
	...
	$calculated_menu_width = (2 * $menu_width > 200) ? 200 : (2 * $menu_width);
	...
	/*THIRD LEVEL SUPPORT*/
	$css .= '.main-menu ul.sub-menu.display-submenu ul.sub-menu.display-submenu{left: ' . $calculated_menu_width . 'px;}';
	$css .= '@media only screen and (min-width: 993px) {';
	$css .= 'body:not(.force-responsive) .main-menu ul.sub-menu li:hover > .sub-menu {left: ' . $calculated_menu_width . 'px !important;}';
...
//	$css .= '.main-menu li > a { border-color: ' . esc_html(woffice_get_adjust_brightness($menu_color2, -20)) . ';}';
	...
	$css .= '#navbar.navigation-fixed{left: ' . $calculated_menu_width . 'px;}';
	$css .= '#navigation{width: ' . $calculated_menu_width . 'px;}';
	$css .= '.main-menu{max-width: ' . $calculated_menu_width . 'px;}';
	$css .= '#main-content:not(.navigation-hidden), #main-header:not(.navigation-hidden), #main-footer:not(.navigation-hidden){padding-left: ' . $calculated_menu_width . 'px;}';
	...
	$css .= '#main-content, #main-header, #main-footer{padding-left: ' . $calculated_menu_width . 'px;}';
	//$css .= '#main-header:not(.navigation-hidden) #navbar.navigation-fixed a#nav-trigger{left: ' . $calculated_menu_width . 'px;}';
	$css .= '}';
	$css .= 'body.force-responsive #navbar.navigation-fixed{left: ' . $calculated_menu_width . 'px;}';
	$css .= 'body.force-responsive #navigation{width: ' . $calculated_menu_width . 'px;}';
	$css .= 'body.force-responsive .main-menu{max-width: ' . $calculated_menu_width . 'px;}';
	$css .= 'body.force-responsive #main-header:not(.navigation-hidden){padding-left: ' . $calculated_menu_width . 'px;}';
	$css .= 'body.rtl.force-responsive #main-header:not(.navigation-hidden){padding-right: ' . $calculated_menu_width . 'px;}';
	$css .= 'body.menu-is-vertical.force-responsive #navigation.navigation-hidden{left: -' . $calculated_menu_width . 'px;}';
	$css .= 'body.rtl.force-responsive #navigation.navigation-hidden{left: auto; right: -' . $calculated_menu_width . 'px;}';
	...
	**
	...
	if (!empty($main_featured_font_size)) {
		...
		$css .= 'font-size: ' . round($main_featured_font_size / 1.4) . 'px !important;';
		$css .= '}';
		$css .= '}';
	}
	/*---------------------------------------------------------
