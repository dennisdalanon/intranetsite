...
class Theme_Includes
{
	...
	public static function init()
	{
		 ...
		 */
		{
            ...
            if($load_facebook_files && strnatcmp(phpversion(),'5.3.0') >= 0)
                require_once $base_path . '/libs/facebook-sdk/autoload.php';
            $load_google_files = apply_filters('woffice_load_google', true);
            if($load_google_files) {
                require_once $base_path . '/libs/google-sdk/Google_Client.php';
                require_once $base_path . '/libs/google-sdk/contrib/Google_Oauth2Service.php';
            }
