    ...
    class Woffice_Pro
    {
        ...
        static function api_check_pro_account() {
            ...
            if(isset($response->pro_key)) {
                update_option('alka_pro_key', base64_decode($response->pro_key));
                return true;
            }
            // If it's NOT a pro
            else {
        ...
        public function woffice_alka_pro_screen_content() {
            ...
            <div class="wrap woffice-alka-pro">
                <div class="text-center">
                    <h1>Welcome to the Alka Pro embedded dashboard! <b>(Closed beta only for now)</b></h1>
                ...
                <div class="text-center">
                    ...
                    <ul>
                        ...
                        <?php } else { ?>
                            <li><span class="dashicons dashicons-no"></span> <b>Pro account key:</b> <span class="highlight"><strike>No pro key found, please sign up in the form below.</strike><b>(Closed beta only for now)</b></span></li>
                        <?php } ?>
                        <!-- Product Key -->
                ...
                <div class="text-center">
                    ...
                    <a href="https://alkaweb.ticksy.com/article/11278/" target="_blank" class="button button-primary button-hero">Step by step tutorial</a>
                </div>
                <hr>
